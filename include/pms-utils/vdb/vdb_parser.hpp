...
PARSER_RULE_T(contents, std::optional<std::vector<pms_utils::vdb::Content>>);
...
PARSER_RULE_T(use_flags, std::optional<std::vector<pms_utils::atom::Useflag>>);
...
PARSER_RULE_T(VDB_IUSE, std::optional<pms_utils::ebuild::iuse>);
PARSER_RULE_T(VDB_KEYWORDS, std::optional<pms_utils::ebuild::keywords>);
...
PARSER_DEFINE(VDB_IUSE, -pms_utils::parsers::ebuild::IUSE >> boost::parser::omit[*boost::parser::ws]);

PARSER_DEFINE(VDB_KEYWORDS, -pms_utils::parsers::ebuild::KEYWORDS >> boost::parser::omit[*boost::parser::ws]);
