...
int main() {
    ...
    {
      auto result = pms_utils::try_parse(atom, pms_utils::parsers::atom::atom());
        assert(result.status == pms_utils::ParserStatus::Success);
    }

    {
      auto category = pms_utils::try_parse(cpv, pms_utils::parsers::atom::category());
        ...
        auto name = pms_utils::try_parse(rest, pms_utils::parsers::atom::name());
    ...
    {
      auto category = pms_utils::try_parse(atom, pms_utils::parsers::atom::category());
